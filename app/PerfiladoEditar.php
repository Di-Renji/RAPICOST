			...
			<div class="min-height-200px">
                ...
                <?php
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $sql = "UPDATE perfilado SET detalle_pe='$detalle', unidad_pe='$unidad', cantidad_pe='$cantidad', precio_pe='$precio', importe_pe='$importe' WHERE id_pe='$id'";
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id_pe"])) {
                        $id = $_GET["id_pe"];
                        $sql = "SELECT * FROM perfilado WHERE id_pe='$id'";
                        $result = $conn->query($sql);

                        if ($result->num_rows > 0) {
                            $row = $result->fetch_assoc();
                            $id = $row["id_pe"];
                            $detalle = $row["detalle_pe"];
                            $unidad = $row["unidad_pe"];
                            $cantidad = $row["cantidad_pe"];
                            $precio = $row["precio_pe"];
                            $importe = $row["importe_pe"];
                        } else {
                    ...
                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">	
                        <div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="form-group">
									<label>ID :</label>
									<input type="text" name="txtIdPe" value='<?php echo $id; ?>' class="form-control">
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Detalle :</label>
									<input type="text" name="txtDetallePe" value='<?php echo $detalle; ?>' class="form-control">
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Unidad de Medida :</label>
									<input type="text" name="txtUnidadPe"  value='<?php echo $unidad; ?>' class="form-control">
								</div>
							</div>
						</div>
                        <div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" name="txtCantidadPe"  value='<?php echo $cantidad; ?>' id="txtCantidadPe" class="form-control">
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Precio (S/.) :</label>
									<input type="text" name="txtPrecioPe"  value='<?php echo $precio; ?>' id="txtPrecioPe" class="form-control">
								</div>
							</div>
						</div>
                        ...
                        <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="number"  value='<?php echo $importe; ?>' name="txtImportePe" id="txtImportePe" readonly="readonly">
							</div>
						</div><br>
