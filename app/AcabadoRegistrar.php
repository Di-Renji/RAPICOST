			...
			<div class="min-height-200px">
                ...
                <?php
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["registrar"])) {
                        ...
                        // Consulta SQL para insertar los datos en la tabla "acabado"
                        $sql = "INSERT INTO acabado (detalle_ac, unidad_ac, cantidad_ac, precio_ac, importe_ac) 
                    ...
                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">						
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Detalle :</label>
									<input type="text" name="txtDetalleAc" class="form-control">
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Unidad de Medida :</label>
									<input type="text" name="txtUnidadAc" class="form-control">
								</div>
							</div>
						</div>
                        <div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" name="txtCantidadAc" id="txtCantidadAc" class="form-control">
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Precio (S/.) :</label>
									<input type="text" name="txtPrecioAc" id="txtPrecioAc" class="form-control">
								</div>
							</div>
						</div>
                        ...
                        <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="number" name="txtImporteAc" id="txtImporteAc" readonly="readonly">
							</div>
						</div><br>
