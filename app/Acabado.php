		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Etapa de Acabado</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								...
								<div class="pull-right">
									<a href="../app/AcabadoRegistrar" class="btn btn-success" rel="content-y" role="button" style="color:white;margin-right:5px;"> <i class="fa fa-file-text"> </i> Registrar </a>
								</div> 
								<script>
				...
				<div class="pd-20 card-box mb-30">
                    <h2 style="width:100%; text-align:center;color:blue;">ETAPA DE ACABADO</h2> <br>
					...
					<?php
						include("../config/conexion.php");
						 ...
						 if (isset($_GET['delete'])) {
							$id = $_GET['delete'];
							$sql = "DELETE FROM acabado WHERE id_ac=$id";
							...
							<?php
								...
								if ($result->num_rows > 0) {
									while ($row = $result->fetch_assoc()) {
										...
										echo "<td>
												<a href='../app/AcabadoEditar?id_ac=" . $row["id_ac"] . "' class='btn btn-warning' style='color:white' role='button'>
													Editar
												</a>
												<a href='../app/Acabado?delete=" . $row["id_ac"] . "' onclick='return confirm(\"¿Estás seguro de eliminar este registro?\")' class='btn btn-danger' role='button'>
													Eliminar
												</a>
											</td>";
										echo "</tr>";
