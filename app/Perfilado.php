		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Etapa de Perfilado</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								...
								<div class="pull-right">
									<a href="../app/PerfiladoRegistrar" class="btn btn-success" rel="content-y" role="button" style="color:white;margin-right:5px;"> <i class="fa fa-file-text"> </i> Registrar </a>
								</div> 
								<script>
				...
				<div class="pd-20 card-box mb-30">
                    <h2 style="width:100%; text-align:center;color:blue;">ETAPA DE PERFILADO</h2> <br>
					...
					<?php
						include("../config/conexion.php");
						 ...
						 if (isset($_GET['delete'])) {
							$id = $_GET['delete'];
							$sql = "DELETE FROM perfilado WHERE id_pe=$id";
							...
							<?php
								...
								if ($result->num_rows > 0) {
									while ($row = $result->fetch_assoc()) {
										...
										echo "<td>
												<a href='../app/PerfiladoEditar?id_pe=" . $row["id_pe"] . "' class='btn btn-warning' style='color:white' role='button'>
													Editar
												</a>
												<a href='../app/Perfilado?delete=" . $row["id_pe"] . "' onclick='return confirm(\"¿Estás seguro de eliminar este registro?\")' class='btn btn-danger' role='button'>
													Eliminar
												</a>
											</td>";
										echo "</tr>";
