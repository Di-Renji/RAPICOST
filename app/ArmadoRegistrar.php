			...
			<div class="min-height-200px">
                ...
                <?php
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["registrar"])) {
                        ...
                        // Consulta SQL para insertar los datos en la tabla "armado"
                        $sql = "INSERT INTO armado (detalle_ar, unidad_ar, cantidad_ar, precio_ar, importe_ar) 
                    ...
                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">						
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Detalle :</label>
									<input type="text" name="txtDetalleAr" class="form-control">
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Unidad de Medida :</label>
									<input type="text" name="txtUnidadAr" class="form-control">
								</div>
							</div>
						</div>
                        <div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" name="txtCantidadAr" id="txtCantidadAr" class="form-control">
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Precio (S/.) :</label>
									<input type="text" name="txtPrecioAr" id="txtPrecioAr" class="form-control">
								</div>
							</div>
						</div>
                        ...
                        <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="number" name="txtImporteAr" id="txtImporteAr" readonly="readonly">
							</div>
						</div><br>
