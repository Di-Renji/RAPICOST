<div class="header">
        ...
        <div class="header-search">
            <form>
                <div class="form-group mb-0">
                    ...
                    <input type="text" class="form-control search-input" placeholder="Realizar Busqueda">
                    <div class="dropdown">
    ...
    <div class="header-right">
        ...
        <div class="user-info-dropdown">
            <div class="dropdown">
                <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                    ...
                    <span class="user-name">Joel L.A.</span>
                </a>
        ...
        <div class="github-link">
            <a href="https://github.com/Di-Renji" target="_blank"><img src="../vendors/images/github.svg" alt=""></a>
        </div>
    </div>
</div>